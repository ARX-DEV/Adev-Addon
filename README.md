...
Необходимо нажать комбинацию клавиш «Ctrl + J» или самостоятельно перейти в раздел загрузок браузера, после чего нажать на кнопку «Сохранить» около загружаемого файла. Более подробная инструкция (со скриншотами) есть в [этой](https://soft-setup.ru/razreshit-skachivanie-fajla-kotoryj-google-chrome-blokiruet/) статье.
...
Такие блокировки это нормально, поскольку в архиве и установщике содержится необходимый для работы скрипта «SampFuncs» (взятый с официального ресурса), на который могут жаловаться встроенные системы защиты операционной системы.
____
[:arrow_up: Оглавление](#оглавление) 
____
...
Такие блокировки это нормально, поскольку в архиве и установщике содержится необходимый для работы скрипта «SampFuncs» (взятый с официального ресурса), на который могут жаловаться антивирусы.
____
