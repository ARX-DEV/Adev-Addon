...
Необходимо нажать комбинацию клавиш «Ctrl + J» или самостоятельно перейти в раздел загрузок браузера, после чего выбрать пункт «Сохранить» около загружаемого файла. Более подробная инструкция (со скриншотами) есть в [этой](https://soft-setup.ru/razreshit-skachivanie-fajla-kotoryj-google-chrome-blokiruet/) статье.
